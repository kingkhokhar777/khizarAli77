...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mKhizarAlikhokhar\033[1;91m...............
...
\033[1;91m☞ Auther     : Khizar Hacker
\033[1;92m☞ WhatsApp   : 03232132362No
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCZ1O9Xfn00z2f-akXOpp0BA
\033[1;93mRIZWAN GANDOO LOUCALL TATATATATATATTA
                                '''
back=0
successfull=[]
checkpoint=[]
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/KhizarHacker')
	    os.system('cd $HOME && git clone https://github.com/kingkhokhar777 ')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Khizar_,Hacker')
	    psb('Congratulations Khizar_Hacker Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Khizar✓')
	    psb('🔓Password ☆ Hacker✓')
	    psb('Subscrib My Youtube Channel Power Of Khokhar✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Khizar_Hacker && python2 Khizar.py')
	elif bm =='3':
